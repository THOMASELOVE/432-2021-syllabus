...
- Nine minute papers (along with other elements of class participation)
- Six labs (five of which are required; the sixth is optional)
- Two quizzes, and
- Two projects
...
- 30 points for completing the ["Welcome to 432" survey]["Welcome to 432" Survey] that most of you did prior to class, and if you haven't done it, please do so now.
- plus up to 45 additional points for Minute Paper responses (5 points for each on-time submission)
- plus up to 30 bonus points for actions that help the class, as awarded during the semester
...
- asking especially helpful questions in the Minute Papers, in TA office hours, before or after class with Dr. Love or on [Piazza](https://piazza.com/case/spring2021/pqhs432)
- providing helpful responses to questions on [Piazza](https://piazza.com/case/spring2021/pqhs432)
- identifying interesting visualizations or uses of ideas we're discussing in class in the popular or scientific media (this is also done via [Piazza](https://piazza.com/case/spring2021/pqhs432))
- plus a few other things that come under the general heading of "being helpful."

Thanks to the bonus, scores up to 105 / 100 in Class Participation are technically possible, although almost everyone in fact will fall in the range of 70 - 100 points. Bonus credit is capped so that no one's class participation score exceeds 105 points.
...
During the semester, there are **six** lab assignments scheduled, the first five of which are required, while the sixth is optional. Professor Love reserves the right to change the number of labs depending on how the class is going during the semester. 
...
3. You are welcome to discuss each Lab with anyone, including Professor Love, the teaching assistants, or your colleagues, but your answer must be prepared by you alone. We especially encourage you to take advantage of TA office hours and [Piazza](https://piazza.com/case/spring2021/pqhs432).
4. In general, we do not guarantee to provide answers to questions that we receive in the last 12 hours before a Lab is due, although we will continue to hold TA office hours up to the deadline. Try not to leave things until the last day. Allow time for computer problems.
...
- The five required labs are each due on Mondays at 9 PM Eastern time, as described in the [Calendar](https://thomaselove.github.io/432/calendar.html). 

### Late Lab Work (Note new policy for Labs 4-6)

For **Labs 4-6**, the following policies are in place.

- Labs received **on time** can receive up to 100% of the available points for the lab. We do not penalize lab work received within one hour of the deadline.
- Labs received more than one hour but less than 12 hours after the deadline for Labs 4-6 will receive a late penalty of 20% of available points on the lab.
- Labs received more than 12 hours after the deadline for Labs 4-6 will not be graded.

For **Labs 1-3**, the following policies were in place.

- Labs received **on time** can receive up to 100% of the available points for the lab. We do not penalize lab work received within one hour of the deadline (so, by Monday at 10 PM Eastern.)
- Labs received more than one hour after the deadline but before noon on the following day (Tuesday) will receive a late penalty of 10% of available points on the lab.
- Lab submissions received after the answer sketch is published at noon Tuesday but within one week of the deadline will receive a late penalty of 25% of available points.
- Lab submissions received more than one week after the deadline will not be graded.

### Calculating Your Overall Lab Grade

To calculate your lab grade, Dr. Love will use the four labs (out of the first five) on which you have the highest score, dropping the lab with the lowest score. The remaining four labs are weighted equally in determining your lab grade.

- This means you can skip one of the first five labs during the semester without penalty.
- If you decide to skip a lab, please submit a note to Canvas by the lab's deadline indicating that you are skipping the lab, so that we don't hound you to submit it.
- Should you run the risk of needing to miss more than one of the first five labs during the semester, follow [the emergency policy][In case of emergency] and contact Dr. Love via email.

The sixth lab is optional, and is graded differently, as is described in the instructions for Lab 06.
...
As we've discussed, for most of the course, [Piazza](https://piazza.com/case/spring2021/pqhs432) will be our tool for asking and answering questions. 
...
Should you need to miss a Quiz, the other Quiz will count for all of the Quiz component of your course grade, and will automatically make the Quiz element your "Weight 3" element in determining your final course average. (See the [Final Grade][Final Grade] section below for details.)

## Projects

During the semester, you will have two projects to complete. 

- Project 1 anticipates you using materials from the first 12 classes.
- Project 2 anticipates you using materials from the first 24 classes.
...
In calculating your project average for your course grade, I will weight Project 1 at 40% and Project 2 at 60%.

Students who cannot complete a project (either 1 or 2) in a timely fashion will receive an incomplete grade until both Projects are completed. A penalty will be applied to late work on projects. 
